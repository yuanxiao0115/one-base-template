...
vi.mock('@/modules/adminManagement/user/composables/useUserRemoteOptions', () => ({
  useUserRemoteOptions: vi.fn(() => remoteOptionMocks)
}));
vi.mock('@/modules/adminManagement/user/composables/useUserStatusActions', () => ({
  useUserStatusActions: statusActionMocks.useUserStatusActions
}));

import { useUserCrudState } from '@/modules/adminManagement/user/composables/useUserCrudState';
