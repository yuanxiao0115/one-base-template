...
describe("bootstrap style entries source", () => {
  it("入口样式应下沉到 public/admin 分支，而不是留在 main.ts", () => {
    const mainSource = readFileSync(new URL("../../main.ts", import.meta.url), "utf8");
    const publicEntrySource = readFileSync(new URL("../public-entry.ts", import.meta.url), "utf8");
    ...
    expect(publicEntrySource).toContain("./public-styles");
