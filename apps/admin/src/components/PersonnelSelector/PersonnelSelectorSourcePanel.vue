<script setup lang="ts">
  ...
  import type { PersonnelBreadcrumbNode, PersonnelNode, PersonnelOrgNode, PersonnelUserNode } from "./types";
...
<template>
  <div class="personnel-selector-source">
    ...
    <div v-if="!props.isSearchMode && breadcrumbItems.length > 0" class="personnel-selector-source__breadcrumb">
      <span v-for="(item, index) in breadcrumbItems" :key="item.id" class="personnel-selector-source__breadcrumb-item">
    ...
    <div v-loading="props.loading" class="personnel-selector-source__node-list">
      <template v-if="props.nodes.length > 0">
        <div v-for="node in props.nodes" :key="node.id" class="personnel-selector-source__node-item">
