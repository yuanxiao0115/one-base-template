...
<template>
  <div id="verify">
    <div v-show="visible" class="mask">
      <div class="verifybox" :style="{ 'max-width': `${parseInt(imgSize.width, 10) + 20}px` }">
        <div class="verifybox-top">
          <div style="position: relative;">
            <div :style="{ height: `${parseInt(setSize.imgHeight, 10) + vSpace}px` }" class="verify-img-out">
              <div
                :style="{
              ...
              >
                ...
                >
                  <div
                    ...
                    :style="{
                      width: `${Math.floor(parseInt(setSize.imgWidth, 10) * 47 / 310)}px`,
                      height: setSize.imgHeight,
                      top: `-${parseInt(setSize.imgHeight, 10) + vSpace}px`,
