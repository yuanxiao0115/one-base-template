...
export type ConfirmTone = 'error' | 'success' | 'warning'
...
async function openSecondaryConfirmWithTone (message: ElMessageBoxOptions['message'],
  tone: ConfirmTone,
...
export const obConfirm = {
  async warn (message: ElMessageBoxOptions['message'], title: ElMessageBoxOptions['title'] = DEFAULT_TITLES.warning, options: ElMessageBoxOptions = {}) {
    return openSecondaryConfirmWithTone(message, 'warning', title, options);
  },
  async success (message: ElMessageBoxOptions['message'],
  ...
  async error (message: ElMessageBoxOptions['message'], title: ElMessageBoxOptions['title'] = DEFAULT_TITLES.error, options: ElMessageBoxOptions = {}) {
    return openSecondaryConfirmWithTone(message, 'error', title, options);
  },
  async prompt (message: ElMessageBoxOptions['message'], title: ElMessageBoxOptions['title'] = DEFAULT_TITLES.warning, options: ElMessageBoxOptions = {}) {
