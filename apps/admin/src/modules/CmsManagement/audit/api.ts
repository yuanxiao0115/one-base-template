...
export const auditApi = {
  listArticles: async (params: ArticleListParams) =>
    obHttp().get<ApiResponse<AuditPageData<ArticleAuditRecord>>>('/cmict/cms/cmsArticleManage', {
      params
    }),
  ...
  listComments: async (params: CommentListParams) =>
    obHttp().get<ApiResponse<AuditPageData<CommentAuditRecord>>>('/cmict/cms/cmsComment/list', {
      params
    }),
