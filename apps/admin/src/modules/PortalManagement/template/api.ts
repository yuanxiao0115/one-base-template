...
export const templateApi = {
  list: async (params: TemplateListParams) =>
    obHttp().get<BizResponse<PageResult<PortalTemplate>>>("/cmict/portal/template/page", { params }),

  detail: async (params: { id: string }) => {
    const res = await obHttp().get<BizResponse<PortalTemplate>>("/cmict/portal/template/detail", { params });
