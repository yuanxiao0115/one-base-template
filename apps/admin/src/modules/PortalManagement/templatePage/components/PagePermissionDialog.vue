...
import {
  ...
  type PagePermissionRoleFieldKey,
  type PagePermissionUserFieldKey
...
type UserField = PagePermissionUserFieldKey;
type RoleField = PagePermissionRoleFieldKey;
...
const roleFields: ReadonlyArray<{ key: RoleField; label: string }> = PAGE_PERMISSION_ROLE_FIELDS;
const userFields: ReadonlyArray<{ field: UserField; label: string }> = PAGE_PERMISSION_USER_FIELDS;
