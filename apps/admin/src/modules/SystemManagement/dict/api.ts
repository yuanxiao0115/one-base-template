...
export type DictItemPageParams = {
  dictId: string
  itemName?: string
  itemValue?: string
  currentPage?: number
...
export type DictItemSavePayload = {
  id?: string
  dictId: string
  itemName: string
  itemValue: string
...
export const dictApi = {
  page: async (params: DictPageParams) => getHttpClient()
  ...
  add: async (data: DictSavePayload) => getHttpClient().post<BizResponse<boolean>>('/cmict/admin/data-dict/add', { data }),

  update: async (data: DictSavePayload) => getHttpClient().post<BizResponse<boolean>>('/cmict/admin/data-dict/update', { data }),

  remove: async (data: { idList: string[] | string }) => getHttpClient().post<BizResponse<boolean>>('/cmict/admin/data-dict/delete', { data })
};

export const dictItemApi = {
  page: async (params: DictItemPageParams) => getHttpClient()
  ...
  add: async (data: DictItemSavePayload) => getHttpClient().post<BizResponse<boolean>>('/cmict/admin/dict-item/add', { data }),

  update: async (data: DictItemSavePayload) => getHttpClient().post<BizResponse<boolean>>('/cmict/admin/dict-item/update', { data }),

  remove: async (data: { idList: string[] | string }) => getHttpClient().post<BizResponse<boolean>>('/cmict/admin/dict-item/delete', { data }),

  toggleStatus: async (data: { ids: string[] | string; isEnable: boolean }) => getHttpClient().post<BizResponse<boolean>>('/cmict/admin/dict-item/deactivate', { data })
};
