...
<template>
  ...
  >
    <el-form-item label="字典编码" prop="dictCode">
      <el-input v-model.trim="model.dictCode" maxlength="50" show-word-limit placeholder="请输入字典编码" />
    </el-form-item>

    <el-form-item label="字典名称" prop="dictName">
      <el-input v-model.trim="model.dictName" maxlength="50" show-word-limit placeholder="请输入字典名称" />
    </el-form-item>
