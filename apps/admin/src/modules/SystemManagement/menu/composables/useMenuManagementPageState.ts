...
import { useCrudPage, type CrudErrorContext, type CrudFormLike } from '@one-base-template/core'
...
export function useMenuManagementPageState() {
  ...
  async function openEditDialog(mode: Extract<DialogMode, 'edit' | 'detail'>, row: MenuPermissionRecord) {
    if (mode === 'edit') {
