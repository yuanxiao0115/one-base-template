...
export type RoleMemberPageParams = {
  roleId: string
  keyWord?: string
  currentPage?: number
  pageSize?: number
...
export type RoleMemberPageData = {
...
export type RoleAssignContactNodeBase = {
  id: string
  parentId: string
  companyId: string
  title: string
...
export const roleAssignApi = {
  listRoles: async (params: { roleName?: string }) => getHttpClient()
  ...
  listMembers: async (params: { roleId: string }) => getHttpClient()
  ...
  removeMembers: async (data: RoleMemberPayload) => getHttpClient().post<BizResponse<boolean>>('/cmict/admin/role/member/remove', { data }),

  getOrgContactsLazy: async (params: { parentId?: string }) => getHttpClient()
  ...
  searchContactUsers: async (params: { search?: string }) => getHttpClient()
