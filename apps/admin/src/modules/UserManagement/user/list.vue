<script setup lang="ts">
  ...
  const { loading, dataList, tablePagination, tableColumns, orgTreeData, searchForm, defaultTreeProps } =
    pageState.table;
...
<template>
  ...
  >
    <UserBindAccountForm ref="bindFormRef" v-model="bindForm" :disabled="bindLoading" :fetch-users="fetchBindUsers" />
  </ObCrudContainer>
</template>
