...
import { type ClientTypeOption, loginLogApi, type LoginLogRecord } from '../login-log/api';
          ...
          >
            <template #action="{ row }">
              <div class="flex gap-3 items-center">
                <el-button link type="primary" :size @click="() => handleOperate(row)">
                  查看
                </el-button>
                <el-button link type="danger" :size @click="() => handleDelete(row)">
                  删除
                </el-button>
              </div>
            </template>
