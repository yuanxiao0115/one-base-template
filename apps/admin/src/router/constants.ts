...
export const APP_RESERVED_ROUTE_PATHS = new Set<string>([...APP_PUBLIC_ROUTE_PATHS, APP_NOT_FOUND_CATCHALL_PATH]);

export const APP_RESERVED_ROUTE_NAMES = new Set<string>(["Login", "Sso", "Forbidden", "NotFound"]);
