...
import type { TenantPermissionTreeNode } from '@/modules/adminManagement/tenant-info/types';
...
vi.mock('@/modules/adminManagement/tenant-info/api', () => ({
  tenantInfoApi: apiMocks
}));

import TenantInfoPermissionDialog from '@/modules/adminManagement/tenant-info/components/TenantInfoPermissionDialog.vue';
