...
import { toUserForm, toUserPayload, type UserForm } from '@/modules/adminManagement/user/form';
import type { UserDetailData } from '@/modules/adminManagement/user/types';
