...
import { createZfwSystemSfssPruneLoginHtmlAssetsPlugin } from './vite-prune-login-plugin';

export function createZfwSystemSfssPlugins() {
  return [
    vue(),
    AutoImport({
      imports: [
    ...
    createZfwSystemSfssPruneLoginHtmlAssetsPlugin()
  ];
}
