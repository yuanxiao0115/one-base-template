...
const pageTitle = computed(() => loginInfoConfig.value?.webLogoText || 'ZfwSystemSfss 管理后台');
...
<template>
  <div
    class="zfw-system-sfss-login"
    :style="{ backgroundImage: backgroundImage ? `url(${backgroundImage})` : undefined }"
  >
    <div class="zfw-system-sfss-login__header">{{ pageTitle }}</div>

    <div class="zfw-system-sfss-login__inner">
      <el-card class="zfw-system-sfss-login__card">
        <ObLoginBoxV2
          v-if="useVerifyLogin"
...
.zfw-system-sfss-login__inner {
  width: 100%;
  display: flex;
  justify-content: center;
}

.zfw-system-sfss-login__card {
  width: 100%;
  max-width: 420px;
}
</style>
