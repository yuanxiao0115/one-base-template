...
export const vueRules = {
  ...
  'vue/no-restricted-block': ['warn', '__never_restricted_block__'],
  'vue/no-restricted-call-after-await': ['warn', { module: '__never_restricted_module__' }],
  'vue/no-restricted-class': ['warn', '__never_restricted_class__'],
  'vue/no-restricted-component-names': ['warn', '__never_restricted_component_name__'],
  'vue/no-restricted-component-options': ['warn', '__never_restricted_component_option__'],
  'vue/no-restricted-custom-event': ['warn', '__never_restricted_custom_event__'],
  'vue/no-restricted-html-elements': ['warn', '__never_restricted_html_element__'],
  'vue/no-restricted-props': ['warn', '__never_restricted_prop__'],
  'vue/no-restricted-static-attribute': ['warn', '__never_restricted_static_attribute__'],
  'vue/no-restricted-syntax': ['warn', "VElement[name='__never_restricted_element__']"],
  'vue/no-restricted-v-bind': ['warn', '__never_restricted_bind_arg__'],
  'vue/no-restricted-v-on': ['warn', '__never_restricted_on_arg__'],
