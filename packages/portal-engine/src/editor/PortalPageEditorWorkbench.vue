...
<template>
  <div class="page">
    <header class="headbar">
      ...
      <el-button class="head-btn" size="small" type="primary" :loading="props.saving" @click="emit('save')">保存</el-button>
      <el-button class="head-btn" size="small" :loading="props.previewLoading" @click="emit('preview')">预览</el-button>
    </header>
