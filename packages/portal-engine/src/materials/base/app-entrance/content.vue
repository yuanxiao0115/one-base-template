    ...
    <el-form label-position="top">
      <ObCard title="入口配置">
        <el-form-item label="单行列数">
          <el-input-number v-model="sectionData.entrance.columnCount" :min="1" :max="6" controls-position="right" />
        </el-form-item>
        ...
        <div class="item-list">
          <div v-for="(item, index) in sectionData.entrance.items" :key="item.id" class="item-card">
            ...
            <el-form-item label="入口 ID">
              <el-input v-model.trim="item.id" maxlength="20" show-word-limit placeholder="例如：oa" />
            </el-form-item>

            <el-form-item label="标题">
              <el-input v-model.trim="item.title" maxlength="20" show-word-limit placeholder="请输入入口标题" />
            </el-form-item>
            ...
            <el-form-item label="角标文案">
              <el-input v-model.trim="item.badge" maxlength="20" show-word-limit placeholder="例如：常用" />
            </el-form-item>
