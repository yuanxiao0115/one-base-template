        ...
        <div class="item-list">
          <div v-for="(item, index) in sectionData.buttons.items" :key="item.id" class="item-card">
            ...
            <el-form-item label="按钮 ID">
              <el-input v-model.trim="item.id" maxlength="20" show-word-limit placeholder="例如：button-1" />
            </el-form-item>

            <el-form-item label="按钮文本">
              <el-input v-model.trim="item.text" maxlength="20" show-word-limit placeholder="请输入按钮文案" />
            </el-form-item>
