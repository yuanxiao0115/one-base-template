    ...
    <div class="base-card-list" :style="wrapperStyleObj">
      ...
      <template v-else>
        <div class="base-card-list__grid" :style="gridStyleObj">
          ...
          >
            <img
              v-if="resolveImage(row)"
              class="base-card-list__image"
            ...
            <div
              v-else
              class="base-card-list__image base-card-list__image--placeholder"
              :style="imageStyleObj"
            >
              无图片
            </div>
            ...
            <p class="base-card-list__description" :style="descriptionStyleObj">
...
function handleRowClick(row: RowData) {
  const valueKey = String(
    normalizedListConfig.value.link.valueKey || normalizedListConfig.value.idKey
  );
