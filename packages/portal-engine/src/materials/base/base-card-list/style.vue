    ...
    <el-form label-position="top">
      <ObCard title="网格与卡片">
        <el-form-item label="列数">
          <el-input-number v-model="sectionData.list.columns" :min="1" :max="4" controls-position="right" />
        </el-form-item>

        <el-form-item label="间距(px)">
          <el-input-number v-model="sectionData.list.gap" :min="0" :max="40" controls-position="right" />
        </el-form-item>

        <el-form-item label="卡片内边距(px)">
          <el-input-number v-model="sectionData.list.cardPadding" :min="0" :max="48" controls-position="right" />
        </el-form-item>
      ...
      <ObCard title="文本样式">
        ...
        <el-form-item label="日期颜色">
          <PortalColorField v-model="sectionData.list.dateColor" show-alpha />
        </el-form-item>
        ...
        <el-form-item label="日期字号(px)">
          <el-input-number v-model="sectionData.list.dateFontSize" :min="12" :max="22" controls-position="right" />
        </el-form-item>
      </ObCard>
    </el-form>
  </div>
...
<script setup lang="ts">
  ...
  sectionData.list = {
    ...
    cardPadding: Number.isFinite(Number(sectionData.list?.cardPadding)) ? Number(sectionData.list.cardPadding) : 12,
    ...
    imageHeight: Number(sectionData.list?.imageHeight) > 0 ? Number(sectionData.list.imageHeight) : 120,
    ...
    titleFontSize: Number(sectionData.list?.titleFontSize) > 0 ? Number(sectionData.list.titleFontSize) : 14,
    descriptionFontSize: Number(sectionData.list?.descriptionFontSize) > 0 ? Number(sectionData.list.descriptionFontSize) : 12,
    dateFontSize: Number(sectionData.list?.dateFontSize) > 0 ? Number(sectionData.list.dateFontSize) : 12,
  };
