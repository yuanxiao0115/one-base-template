<template>
  <div class="content-config">
    ...
    <el-form label-position="top">
      ...
      <ObCard title="轮播项">
        <div class="item-list">
          <div v-if="!sectionData.carousel.items.length" class="item-empty">暂无轮播项，请点击“新增轮播项”。</div>
          ...
          <div v-for="(item, index) in sectionData.carousel.items" :key="item.id" class="item-card">
            ...
            <el-form-item label="标题">
              <el-input v-model.trim="item.title" maxlength="40" show-word-limit placeholder="请输入标题" />
            </el-form-item>
...
<script setup lang="ts">
  ...
  sectionData.carousel = {
    ...
    interval: Number(sectionData.carousel?.interval) >= 1000 ? Number(sectionData.carousel.interval) : 4000,
