    ...
    <el-form label-position="top">
      <ObCard title="轮播样式">
        <el-form-item label="高度(px)">
          <el-input-number
            v-model="sectionData.carousel.height"
            :min="160"
            :max="1200"
        ...
        <el-form-item label="圆角(px)">
          <el-input-number
            v-model="sectionData.carousel.borderRadius"
            :min="0"
            :max="64"
            controls-position="right"
          />
        ...
        <el-form-item label="遮罩背景">
          <ObColorField v-model="sectionData.carousel.overlayBgColor" show-alpha />
        </el-form-item>
        ...
        <el-form-item label="内容横向内边距(px)">
          <el-input-number
            v-model="sectionData.carousel.contentPaddingX"
            :min="0"
            :max="120"
            controls-position="right"
          />
        ...
        <el-form-item label="内容纵向内边距(px)">
          <el-input-number
            v-model="sectionData.carousel.contentPaddingY"
            :min="0"
            :max="120"
            controls-position="right"
          />
      ...
      <ObCard title="标题文字">
        <el-form-item label="标题颜色">
          <ObColorField v-model="sectionData.carousel.titleColor" show-alpha />
        </el-form-item>

        <el-form-item label="标题字号(px)">
          <el-input-number
            v-model="sectionData.carousel.titleFontSize"
            :min="14"
            :max="56"
            controls-position="right"
          />
        ...
        <el-form-item label="副标题颜色">
          <ObColorField v-model="sectionData.carousel.subtitleColor" show-alpha />
        </el-form-item>

        <el-form-item label="副标题字号(px)">
          <el-input-number
            v-model="sectionData.carousel.subtitleFontSize"
            :min="12"
            :max="40"
            controls-position="right"
          />
...
sectionData.carousel = {
  ...
  borderRadius: Number.isFinite(Number(sectionData.carousel?.borderRadius))
    ? Number(sectionData.carousel.borderRadius)
    : 10,
  ...
  titleFontSize:
    Number(sectionData.carousel?.titleFontSize) > 0
      ? Number(sectionData.carousel.titleFontSize)
      : 20,
  subtitleFontSize:
    Number(sectionData.carousel?.subtitleFontSize) > 0
      ? Number(sectionData.carousel.subtitleFontSize)
      : 14,
  contentAlign:
    sectionData.carousel?.contentAlign === 'center' ||
    sectionData.carousel?.contentAlign === 'right'
