    ...
    <el-form label-position="top">
      ...
      <ObCard title="提交配置">
        <el-form-item label="提交按钮文案">
          <el-input v-model.trim="sectionData.form.submitText" maxlength="20" show-word-limit placeholder="例如：提交" />
        </el-form-item>

        <el-form-item label="重置按钮文案">
          <el-input v-model.trim="sectionData.form.resetText" maxlength="20" show-word-limit placeholder="例如：重置" />
        </el-form-item>
        ...
        <el-form-item label="成功字段路径">
          <el-input v-model.trim="sectionData.form.successPath" maxlength="60" show-word-limit placeholder="例如：code" />
        </el-form-item>

        <el-form-item label="成功期望值">
          <el-input v-model.trim="sectionData.form.successValue" maxlength="40" show-word-limit placeholder="例如：200" />
        </el-form-item>
...
<script setup lang="ts">
  ...
  sectionData.form = {
    ...
    submitText: typeof sectionData.form?.submitText === 'string' && sectionData.form.submitText.trim() ? sectionData.form.submitText : '提交',
    resetText: typeof sectionData.form?.resetText === 'string' && sectionData.form.resetText.trim() ? sectionData.form.resetText : '重置',
    apiUrl: typeof sectionData.form?.apiUrl === 'string' ? sectionData.form.apiUrl : '',
    method: sectionData.form?.method === 'PUT' || sectionData.form?.method === 'PATCH' ? sectionData.form.method : 'POST',
    headersJson: typeof sectionData.form?.headersJson === 'string' ? sectionData.form.headersJson : '{}',
    extraBodyJson: typeof sectionData.form?.extraBodyJson === 'string' ? sectionData.form.extraBodyJson : '{}',
    successPath: typeof sectionData.form?.successPath === 'string' && sectionData.form.successPath.trim() ? sectionData.form.successPath : 'code',
    successValue:
