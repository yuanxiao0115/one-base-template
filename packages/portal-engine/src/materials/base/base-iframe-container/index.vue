...
<script setup lang="ts">
  ...
  import { normalizeIframeSource, toNonNegativeNumber, toPositiveNumber } from '../common/material-utils';
  ...
  const iframeLoading = computed<LoadingType>(() => (iframeConfig.value.loading === 'eager' ? 'eager' : 'lazy'));
