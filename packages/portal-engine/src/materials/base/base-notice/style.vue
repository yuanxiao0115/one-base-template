    ...
    <el-form label-position="top">
      <ObCard title="公告样式">
        <el-form-item label="容器高度(px)">
          <el-input-number v-model="sectionData.notice.height" :min="30" :max="96" controls-position="right" />
        </el-form-item>

        <el-form-item label="圆角(px)">
          <el-input-number v-model="sectionData.notice.radius" :min="0" :max="28" controls-position="right" />
        </el-form-item>

        <el-form-item label="背景色">
          <PortalColorField v-model="sectionData.notice.backgroundColor" show-alpha />
        </el-form-item>

        <el-form-item label="边框色">
          <PortalColorField v-model="sectionData.notice.borderColor" show-alpha />
        </el-form-item>

        <el-form-item label="文字颜色">
          <PortalColorField v-model="sectionData.notice.textColor" show-alpha />
        </el-form-item>

        <el-form-item label="文字字号(px)">
          <el-input-number v-model="sectionData.notice.textFontSize" :min="12" :max="24" controls-position="right" />
        </el-form-item>

        <el-form-item label="圆点颜色">
          <PortalColorField v-model="sectionData.notice.bulletColor" show-alpha />
        </el-form-item>

        <el-form-item label="图标颜色">
          <PortalColorField v-model="sectionData.notice.iconColor" show-alpha />
        </el-form-item>
      </ObCard>
    </el-form>
  </div>
...
<script setup lang="ts">
  ...
  sectionData.notice = {
    ...
    radius: Number.isFinite(Number(sectionData.notice?.radius)) ? Number(sectionData.notice.radius) : 8,
    ...
    textFontSize: Number(sectionData.notice?.textFontSize) > 0 ? Number(sectionData.notice.textFontSize) : 14,
