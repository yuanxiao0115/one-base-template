...
<script setup lang="ts">
  ...
  import { mergePortalLinkConfig, openPortalLink, type PortalLinkConfig } from '../common/portal-link';
  ...
  function handleSearch() {
    ...
    const paramKey = String(searchConfig.value.keywordParamKey || searchLink.value.paramKey || 'keyword').trim() || 'keyword';
