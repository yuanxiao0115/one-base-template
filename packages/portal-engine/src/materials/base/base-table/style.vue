    ...
    <el-form label-position="top">
      <ObCard title="表头样式">
        <el-form-item label="表头背景色">
          <PortalColorField v-model="sectionData.table.headerBgColor" show-alpha />
        </el-form-item>

        <el-form-item label="表头文字色">
          <PortalColorField v-model="sectionData.table.headerTextColor" show-alpha />
        </el-form-item>

        <el-form-item label="表头字号(px)">
          <el-input-number v-model="sectionData.table.headerFontSize" :min="12" :max="36" controls-position="right" />
        </el-form-item>

        <el-form-item label="表头圆角(px)">
          <el-input-number v-model="sectionData.table.headerRadius" :min="0" :max="32" controls-position="right" />
        </el-form-item>
      </ObCard>

      <ObCard title="行样式">
        <el-form-item label="行文字色">
          <PortalColorField v-model="sectionData.table.rowTextColor" show-alpha />
        </el-form-item>

        <el-form-item label="行字号(px)">
          <el-input-number v-model="sectionData.table.rowFontSize" :min="12" :max="30" controls-position="right" />
        </el-form-item>

        <el-form-item label="行悬停背景">
          <PortalColorField v-model="sectionData.table.rowHoverBgColor" show-alpha />
        </el-form-item>

        <el-form-item label="行分割线颜色">
          <PortalColorField v-model="sectionData.table.dividerColor" show-alpha />
        </el-form-item>
      </ObCard>

      <ObCard title="链接与圆点">
        <el-form-item label="链接颜色">
          <PortalColorField v-model="sectionData.table.linkColor" show-alpha />
        </el-form-item>

        <el-form-item label="圆点颜色">
          <PortalColorField v-model="sectionData.table.dotColor" show-alpha />
        </el-form-item>

        <el-form-item label="圆点大小(px)">
          <el-input-number v-model="sectionData.table.dotSize" :min="4" :max="20" controls-position="right" />
        </el-form-item>
      </ObCard>
      ...
      <ObCard title="分页">
        ...
        <el-form-item label="分页上间距(px)">
          <el-input-number v-model="sectionData.table.paginationTopGap" :min="0" :max="120" controls-position="right" />
        </el-form-item>
      </ObCard>
    </el-form>
  </div>
...
<script setup lang="ts">
  ...
  sectionData.table = {
    ...
    headerFontSize: Number(sectionData.table?.headerFontSize) > 0 ? Number(sectionData.table.headerFontSize) : 14,
    headerRadius: Number.isFinite(Number(sectionData.table?.headerRadius)) ? Number(sectionData.table.headerRadius) : 8,
    rowTextColor: sectionData.table?.rowTextColor || '#334155',
    rowFontSize: Number(sectionData.table?.rowFontSize) > 0 ? Number(sectionData.table.rowFontSize) : 14,
