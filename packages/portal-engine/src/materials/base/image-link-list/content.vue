    ...
    <el-form label-position="top">
      <ObCard title="列表配置">
        <el-form-item label="单行列数">
          <el-input-number v-model="sectionData.list.columnCount" :min="1" :max="4" controls-position="right" />
        </el-form-item>
        ...
        <div class="item-list">
          <div v-for="(item, index) in sectionData.list.items" :key="item.id" class="item-card">
            ...
            <el-form-item label="项 ID">
              <el-input v-model.trim="item.id" maxlength="20" show-word-limit placeholder="例如：img-1" />
            </el-form-item>

            <el-form-item label="标题">
              <el-input v-model.trim="item.title" maxlength="20" show-word-limit placeholder="请输入标题" />
            </el-form-item>
            ...
            <el-form-item label="标签文案">
              <el-input v-model.trim="item.tag" maxlength="20" show-word-limit placeholder="例如：推荐" />
            </el-form-item>
