<template>
  <el-collapse-item title="轮播图样式" name="carousel">
    ...
    <el-form-item label="指示器颜色">
      <div class="form-item-with-tip">
        <ObColorField v-model="modelValue.indicatorColor" show-alpha />
    ...
    <el-form-item label="箭头颜色">
      <div class="form-item-with-tip">
        <ObColorField v-model="modelValue.arrowColor" show-alpha />
    ...
    <template v-if="modelValue.showTitle">
      <el-form-item label="标题背景色">
        <div class="form-item-with-tip">
          <ObColorField v-model="modelValue.titleBackground" show-alpha />
      ...
      <el-form-item label="页码颜色">
        <div class="form-item-with-tip">
          <ObColorField v-model="modelValue.pageIndicatorColor" show-alpha />
