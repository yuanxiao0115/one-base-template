<template>
  <el-collapse-item title="容器样式" name="container">
    <el-form-item label="背景颜色">
      <div class="form-item-with-tip">
        <ObColorField v-model="containerStyleData.containerBgColor" show-alpha />
    ...
    <el-form-item label="阴影效果">
      <div class="form-item-with-tip">
        <div class="shadow-samples">
          ...
          >
            <div class="shadow-preview" style="box-shadow: 0 2px 4px rgb(0 0 0 / 0.1)">
              <span>浅阴影</span>
            </div>
          </div>
          <div
          ...
          >
            <div class="shadow-preview" style="box-shadow: 0 4px 8px rgb(0 0 0 / 0.1)">
              <span>中等阴影</span>
            </div>
          </div>
          <div
          ...
          >
            <div class="shadow-preview" style="box-shadow: 0 8px 16px rgb(0 0 0 / 0.15)">
              <span>深阴影</span>
            </div>
          </div>
        </div>
  ...
  <el-collapse-item title="内容区域样式" name="content">
    <el-form-item label="背景颜色">
      <div class="form-item-with-tip">
        <ObColorField v-model="containerStyleData.contentBgColor" show-alpha />
