<template>
  <div class="list-config">
    ...
    <el-form-item label="最大显示条数">
      <el-input-number v-model="modelValue.maxDisplayCount" :min="1" :max="20" controls-position="right" />
    </el-form-item>

    <el-form-item label="卡片宽度">
      <div class="input-with-unit">
        <el-input-number v-model="modelValue.cardWidth" :min="80" :max="600" controls-position="right">
    ...
    <el-form-item label="卡片间距">
      <div class="input-with-unit">
        <el-input-number v-model="modelValue.cardGap" :min="0" :max="200" controls-position="right">
          <template #suffix> <span class="suffix-unit">px</span> </template>
        </el-input-number>
      </div>
    </el-form-item>
    ...
    <el-form-item label="标题字体大小">
      <div class="input-with-unit">
        <el-input-number v-model="modelValue.titleFontSize" :min="10" :max="36" controls-position="right">
          <template #suffix> <span class="suffix-unit">px</span> </template>
        </el-input-number>
      </div>
    </el-form-item>
    ...
    <el-form-item label="标题最大字数">
      <div class="input-with-unit">
        <el-input-number v-model="modelValue.titleMaxChars" :min="1" :max="50" controls-position="right" />
      </div>
    </el-form-item>
  </div>
</template>
