    ...
    <el-form label-position="top">
      <ObCard title="容器样式">
        <el-form-item label="背景颜色">
          <ObColorField v-model="modelValue.backgroundColor" show-alpha />
        </el-form-item>
      ...
      <ObCard title="标题区样式">
        <el-form-item label="标题区背景">
          <ObColorField v-model="modelValue.headerBackgroundColor" show-alpha />
        </el-form-item>

        <el-form-item label="标题区分割线">
          <ObColorField v-model="modelValue.headerDividerColor" show-alpha />
        </el-form-item>
        ...
        <el-form-item label="副标题颜色">
          <ObColorField v-model="modelValue.subtitleColor" show-alpha />
        </el-form-item>

        <el-form-item label="副标题字号(px)">
          <el-input-number
            v-model="modelValue.subtitleFontSize"
            :min="10"
            :max="40"
            controls-position="right"
          />
        ...
        <el-form-item label="图标颜色">
          <ObColorField v-model="modelValue.iconColor" show-alpha />
        </el-form-item>
        ...
        <el-form-item label="标题区与内容间距(px)">
          <el-input-number
            v-model="modelValue.contentTopGap"
            :min="0"
            :max="120"
            controls-position="right"
          />
