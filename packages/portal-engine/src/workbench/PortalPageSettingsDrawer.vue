...
const submitLoading = computed(() =>
  activeTabModel.value === 'header' || activeTabModel.value === 'footer'
    ? props.shellLoading
    : props.loading
);
...
function buildDraftSettings(source?: PortalPageSettingsV2 | null): PortalPageSettingsV2 {
  return JSON.parse(
    JSON.stringify(normalizePortalPageSettingsV2(source ?? createDefaultPortalPageSettingsV2()))
  ) as PortalPageSettingsV2;
}
