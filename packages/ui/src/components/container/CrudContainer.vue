<script setup lang="ts">
  ...
  const emit = defineEmits<{
    ...
    (event: 'close' | 'cancel' | 'confirm'): void;
  }>();
  ...
  const dialogContainerClass = computed(() => ['ob-crud-container', 'ob-crud-container--dialog', modeClass.value]);
  ...
  >
    ...
    <template v-if="showFooter" #footer>
      ...
      <div v-else class="ob-crud-container__footer">
        ...
        <el-button v-if="showConfirmButton" type="primary" :loading="!isDetailMode && loading" @click="onConfirm">
          {{ confirmLabel }}
        </el-button>
      </div>
    </template>
