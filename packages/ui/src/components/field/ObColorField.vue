...
<template>
  <div class="ob-color-field portal-color-field">
    <el-color-picker
      class="ob-color-field__picker"
    ...
    >
      <template #prefix>
        <span class="ob-color-field__prefix">HEX</span>
      </template>
    </el-input>

    <div class="ob-color-field__actions">
      <el-button
        link
        type="primary"
        size="small"
        class="ob-color-field__transparent-btn"
...
.ob-color-field__picker {
  width: 76px;
}

.ob-color-field__picker :deep(.el-color-picker__trigger) {
  width: 76px;
  height: 32px;
  border-radius: 4px;
}

.ob-color-field__input {
  width: 100%;
}

.ob-color-field__prefix {
  font-size: 11px;
  color: #64748b;
  font-weight: 600;
...
.ob-color-field__transparent-btn {
  padding: 0;
}

.ob-color-field__transparent-btn.is-active {
  font-weight: 600;
}
</style>
