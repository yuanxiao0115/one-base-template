<script setup lang="ts">
  ...
  const openeds = computed(() => findOpenPaths(menuItems.value, activePath.value));
...
<template>
  <el-scrollbar class="h-full">
    <el-menu
      ...
      @select="onSelect"
    >
      <MenuItem v-for="item in menuItems" :key="item.path" :item="item" :collapsed="isCollapsed" />
    </el-menu>
  </el-scrollbar>
</template>
