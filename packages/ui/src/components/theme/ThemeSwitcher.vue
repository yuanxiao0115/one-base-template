    ...
    <section class="ob-personalize__section">
      ...
      <div class="ob-theme-grid">
        <button
          ...
          class="ob-theme-card"
          :class="{
            'is-active': themeStore.themeMode === 'preset' && themeStore.themeKey === item.key
          }"
    ...
    <section v-if="themeStore.allowCustomPrimary" class="ob-personalize__section">
      ...
      <div class="ob-custom-panel">
        <div class="ob-custom-panel__meta">
          <span
            class="ob-custom-panel__swatch"
            :style="{ background: customPrimaryValue }"
            aria-hidden="true"
          />
          <div>
            <small>当前主色</small>
