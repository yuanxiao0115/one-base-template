...
<template>
  <div class="ob-topbar" :style="headerStyle">
    <div class="ob-topbar__left">
      ...
      <el-dropdown v-if="showSystemSwitcherDropdown" class="ob-topbar__system" @command="onSwitchSystem">
        <span class="ob-topbar__system-trigger" :title="currentSystemName"> 切换系统：{{ currentSystemName }} </span>
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item v-for="sys in systemStore.systems" :key="sys.code" :command="sys.code">
              {{ sys.name }}
            </el-dropdown-item>
          </el-dropdown-menu>
        </template>
    ...
    <div class="ob-topbar__right">
      <el-dropdown class="ob-topbar__user">
        <span class="ob-topbar__user-trigger" :title="userName"> {{ userName }} </span>
        <template #dropdown>
          <el-dropdown-menu>
