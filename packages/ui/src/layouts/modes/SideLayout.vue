...
const collapseIcon = computed(() =>
  layoutStore.siderCollapsed ? 'ri:menu-unfold-line' : 'ri:menu-fold-line'
);
  ...
  <div class="h-screen w-screen flex flex-col bg-[var(--el-bg-color-page)]">
    ...
    <div class="flex-1 min-h-0 flex">
      <aside
        ...
        :style="sidebarStyle"
      >
        <div class="flex-1 min-h-0"><SidebarMenu :collapsed="layoutStore.siderCollapsed" /></div>

        <div
          class="ob-side-layout__collapse-panel shrink-0 border-t border-[var(--el-border-color)]"
        >
